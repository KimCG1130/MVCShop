...
<%@ page import="com.model2.mvc.common.Page"%><!-- page관련 클래스 추가 -->
<%@ page import="com.model2.mvc.common.util.CommonUtil"%>


<%
	List<Product> list= (List<Product>)request.getAttribute("list");
	Page resultPage=(Page)request.getAttribute("resultPage");//common의 page
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	...
	<tr class="ct_list_pop">
		...
		<td></td>
		<td align="left">
			<a href="/getProduct.do?prodNo=<%=product.getProdNo() %>"><%= product.getProdName() %></a><!-- 수정 및 검색 -->
		</td>
		<td></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	<tr>
		...
		<input type="hidden" id="currentPage" name="currentPage" value=""/>
			...
			<% } %><!--  -->--%>
			<jsp:include page="../common/pageNavigator(product).jsp"/>
